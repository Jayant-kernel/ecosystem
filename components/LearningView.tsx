...
const LearningView: React.FC<LearningViewProps> = ({ course, navigateTo }) => {
    ...
    const handleToolCall = useCallback(async (functionCalls: TutorToolCall[]): Promise<TutorToolResponse[]> => {
        ...
        return responses;
    }, [applyHighlight, applyHighlightLines, clearHighlight, clearHighlightTimers, closeTeachingSession, getTeachingCodeInfo, showTeachingStep, currentLesson, handleRunCode, handleResetCode, handleCompleteLesson, visualPlan, visualScene.activeStep]);
